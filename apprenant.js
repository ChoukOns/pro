...
const [show, setShow] = useState(false);
  ...
  const handleShow = () => {
    // Vérifiez et loggez les propriétés de user et courses
    ...
    if (user && user.id && courses && courses.length > 0 && courses[0]._id) {
      ...
      setCoursId(courses[0]._id); // Accédez à la première entrée de courses pour obtenir l'ID
    } else {
